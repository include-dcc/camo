 ...
 * [camo.yml](camo.yml)
     * Determines how your purl.obolibrary.org/obo/camo/ redirects will be handled
     ...
     * Paste in the contents of [camo.yml](camo.yml)
 ...
 * [camo.md](camo.md)
     ...
     * Paste in the contents of [camo.md](camo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
